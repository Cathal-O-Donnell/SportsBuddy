...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("S00144297MobileDev.NewPostActivity, S00144297MobileDev, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NewPostActivity.class, __md_methods);
	}


	public NewPostActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == NewPostActivity.class)
			mono.android.TypeManager.Activate ("S00144297MobileDev.NewPostActivity, S00144297MobileDev, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
